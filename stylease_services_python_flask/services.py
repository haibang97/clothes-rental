...
def get_backgrounds():
    conn = connect(user="root",password="",host="127.0.0.1",database="background")
    cursor = conn.cursor()
...
def get_all_clothes():
    conn = connect(user="root",password="",host="127.0.0.1",database="clothesclass")
    cursor = conn.cursor()
...
def get_all_deliveryman():
    conn = connect(user="root",password="",host="127.0.0.1",database="delivery")
    cursor = conn.cursor()
